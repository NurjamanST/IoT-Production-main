    ...
    <div class="row mt-4 text-center justify-content-center">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-2">
            <div class="border p-3 rounded shadow">
                <h5>Lampu 1</h5>
                <img src="<?php echo e(('image/Icons/lampu.png')); ?>" alt="Lampu" class="img-fluid">
                <div class="mt-2">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-2">
            <div class="border p-3 rounded shadow">
                <h5>Kipas</h5>
                <img src="<?php echo e(('image/Icons/kipas.png')); ?>" alt="Kipas" class="img-fluid">
                <div class="mt-2">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-2">
            <div class="border p-3 rounded shadow">
                <h5>Kabel</h5>
                <img src="<?php echo e(('image/Icons/kabel.png')); ?>" alt="Kabel" class="img-fluid">
                <div class="mt-2">
...
<?php endif; ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const apiUrl = "<?php echo e(('https://meniti.id/IoT-Production-main/public/api/smarthome')); ?>";
            console.log(apiUrl);
