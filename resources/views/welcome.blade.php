  ...
  <section id="produk">
          ...
          <div class="d-flex align-items-center mb-4" style="width: 100%; gap: 12px; height: 180px;">
            ...
            <div style="flex: 0 0 17%; height: 100%;">
              <div class="position-relative w-100 h-100">
                <img src="{{ url('image/Produk/smarthomestarterkit.jpg') }}" class="img-fluid rounded border w-100 h-100 object-fit-cover" alt="Thumbnail Foto">
            ...
            <div style="flex: 0 0 49%; height: 100%;" class="d-flex flex-column justify-content-between">
              ...
              <div class="d-flex justify-content-between gap-2">
                ...
                <a href="{{ url('house') }}" class="btn btn-sm rounded" style="background-color: #0d2b57; color: white;">Demo Web <i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container-fluid">
          ...
          <div class="d-flex align-items-center mb-4" style="width: 100%; gap: 12px; height: 180px;">
            ...
            <div style="flex: 0 0 17%; height: 100%;">
              <div class="position-relative w-100 h-100">
                <img src="{{ url('image/Produk/rfidstarterkit.jpg') }}" class="img-fluid rounded border w-100 h-100 object-fit-cover" alt="Thumbnail Foto">
                <div class="position-absolute top-50 start-50 translate-middle text-center fw-bold text-black" style="width: 100%; font-size: 10px;">
                  Thumbnail Products <br> (Picture)
                </div>
              </div>
            ...
            <div style="flex: 0 0 30%; height: 100%;">
              <div class="position-relative w-100 h-100">
                <img src="{{ url('image/Produk/rfidtrainingkit.jpg') }}" class="img-fluid rounded border w-100 h-100 object-fit-cover" alt="Thumbnail Video">
                <div class="position-absolute top-50 start-50 translate-middle text-center fw-bold text-black" style="width: 100%; font-size: 10px;">
                  Thumbnail Products <br> (Video)
                </div>
              </div>
